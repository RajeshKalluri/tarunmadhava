    ...
    <div>
        ...
        <div className="flex items-center justify-between max-w-screen-xl mx-auto px-6 py-3 text-white">
          ...
          <div className="lg:hidden">
            <button
              ...
              className="focus:outline-none text-[#002E5B] hover:text-[#da9f7e]"
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <div className="hidden lg:flex flex-[2] gap-x-12 text-sm font-semibold items-center">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div className="absolute bg-gray-900 shadow-lg mt-2 rounded-md z-30 w-40 text-white">
                    <Link
                      to="/financialCalculators"
                      className="block px-4 py-2 hover:bg-[#da9f7e]"
            ...
            <div className="flex gap-4 text-[#002E5B]">
              <a href="https://www.facebook.com/profile.php?id=61563002765802">
                <FaFacebook className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/company/munna-llc-mandava-financial-services/">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden px-6 pb-6 flex flex-col space-y-5 text-sm font-semibold text-[#002E5B]">
            ...
            <Link
              ...
              onClick={closeMobileMenu}
              className={`py-2 ${
                isActive("/aboutus") ? activeClass : defaultClass
              }`}
            >
              ABOUT US
            </Link>
            ...
            <div className="flex flex-col">
              ...
              {mobileDropdownOpen && (
                <div className="ml-4 mt-2 flex flex-col space-y-3 text-sm transition-all duration-300">
                  ...
                  <Link to="/faq" onClick={closeMobileMenu} className="py-1">
                    FAQ
                  </Link>
                </div>
              )}
            ...
            <Link
              ...
              onClick={closeMobileMenu}
              className={`py-2 ${
                isActive("/partnership") ? activeClass : defaultClass
              }`}
            >
              PARTNERSHIP
            </Link>
            ...
            <Link
              ...
              onClick={closeMobileMenu}
              className={`py-2 ${
                isActive("/contactus") ? activeClass : defaultClass
              }`}
            >
              CONTACT US
            </Link>
      ...
      <div className="pt-6">
        <Routes>
          ...
          <Route
            ...
            element={<Retirement_planning />}
          ></Route>
          <Route
            path="/college_planning"
            element={<College_planning></College_planning>}
          ></Route>
          <Route
            path="/tax_planning"
            element={<Tax_planning></Tax_planning>}
          ></Route>
      ...
      <footer className="bg-[#333333] text-white">
        ...
        <div className="max-w-screen-xl mx-auto px-6 sm:px-12 md:px-16 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-sm">
          <div>
            <h3 className="text-xl font-bold border-t-2 border-[#d89e7f] pt-2 mb-3">
              ABOUT
            </h3>
            <p className="text-gray-300">
              At Mandava Financial Services, we strive to simplify your
              financial life after your retirement. We help high-net-worth
              families and business owners set tangible goals and then put
              strategies in place to achieve those goals through thoughtful
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <Link to="/retirement_planning">Retirement Planning</Link>
              </li>
              <li>
                <Link to="/college_planning">College Planning</Link>
              </li>
              <li>
                <Link to="/tax_planning">Tax Planning</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-400 py-4 px-6 flex flex-col sm:flex-row justify-between items-center text-gray-400 text-sm">
          <p className="text-center sm:text-left">
            &copy; 2025 Mandava Financial Services Inc.
          </p>
          ...
          <div className="flex gap-4 mt-3 sm:mt-0">
            <a
              href="https://www.facebook.com/profile.php?id=61563002765802"
              aria-label="Facebook"
              className="bg-white text-[#002e5b] p-2 rounded-full"
            >
